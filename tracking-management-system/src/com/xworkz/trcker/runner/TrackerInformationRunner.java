...
public class TrackerInformationRunner {
    public static void main(String[] args) {
        ...
        TrackingInformationDto tracker = new TrackingInformationDto(987790, "pc", "Ganesh mobiles", "BTM", LocalDateTime.of(2024, 9, 17, 12, 34), LocalDateTime.of(2024, arraySize, arraySize, arraySize, arraySize));
        ...
        System.out.println(trackerInformation.updateByTrackerId(987790, tracker2));
