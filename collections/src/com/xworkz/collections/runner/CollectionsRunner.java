...
public class CollectionsRunner {
	...
	public static void main(String[] args) {
		...
		number.add(9);
		number.add(8768);
		Comparator<Integer> comparators=(Integer s1,Integer s2)->s2.compareTo(s1);
		Collections.sort(number,comparators);
		System.out.println(number);
		List<String> stream = new LinkedList<String>();
		stream.add("c");
		stream.add("I");
		stream.add("E");
		stream.add("C");
		stream.add("M");
		stream.add("F");
		Comparator<String> comp=(String s1,String s2)->s2.compareToIgnoreCase(s1);
